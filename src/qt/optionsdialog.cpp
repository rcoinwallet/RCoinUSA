        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start RCoinUSA on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start RCoinUSA after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the RCoinUSA client port on the router. This only works when your router supports UPnP and it is enabled."));
        ...
        QWidget(parent)
{
    ...
    display_addresses->setToolTip(tr("Whether to show RCoinUSA addresses in the transaction list"));
