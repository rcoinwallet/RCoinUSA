 ...
 * 2016-2017 The RCoinUSA developers
 */
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. RCoinUSA can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    {
        if (strlen(argv[i]) >= 7 && strncasecmp(argv[i], "RCoinUSA:", 7) == 0)
        {
    ...
    app.setOrganizationName("RCoinUSA");
    app.setOrganizationDomain("RCoinUSA.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("RCoinUSA-Qt-testnet");
    else
        app.setApplicationName("RCoinUSA-Qt");
